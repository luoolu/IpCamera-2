...
public class ScanQRActivity extends AppCompatActivity implements SurfaceHolder.Callback, View.OnClickListener {
    ...
    private com.mining.app.zxing.view.ViewfinderView viewfinderView;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        viewfinderView = (com.mining.app.zxing.view.ViewfinderView) findViewById(R.id.viewfinder_view);
    ...
    private void onResultHandler(String resultString, Bitmap bitmap) {
        if (TextUtils.isEmpty(resultString)) {
            Toast.makeText(ScanQRActivity.this, "扫描失败!", Toast.LENGTH_SHORT).show();
            return;
        }
    ...
    public com.mining.app.zxing.view.ViewfinderView getViewfinderView() {
